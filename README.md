...
| ------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 🌐 [Meu Site](https://github.com/ewtfiwl/meu-site/)                                        | Site pessoal responsivo com HTML/CSS, layout moderno e animações suaves                                        | <p align="center"><a href="https://github.com/ewtfiwl/meu-site/"><img src="img/Print-meu-site.png" width="220" style="border-radius:10px;" /></a></p>                  |
...
| 🧶 [Projetos Visuais](https://github.com/ewtfiwl/html-css-js-notes/tree/main/Position%202) | Positions 2 — Experimento com position e z-index para controlar sobreposição e deslocamento de elementos HTML. | <p align="center"><a href="#"><img src="img/Position2.png" width="220" style="border-radius:10px;" /></a></p>                                                          |
